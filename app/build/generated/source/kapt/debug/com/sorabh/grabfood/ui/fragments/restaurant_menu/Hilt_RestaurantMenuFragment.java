...
public abstract class Hilt_RestaurantMenuFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestaurantMenuFragment_GeneratedInjector) this.generatedComponent()).injectRestaurantMenuFragment(UnsafeCasts.<RestaurantMenuFragment>unsafeCast(this));
    }
  }
