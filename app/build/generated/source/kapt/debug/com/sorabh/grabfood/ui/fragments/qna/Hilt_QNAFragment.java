 ...
 */
public abstract class Hilt_QNAFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QNAFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QNAFragment_GeneratedInjector) this.generatedComponent()).injectQNAFragment(UnsafeCasts.<QNAFragment>unsafeCast(this));
    }
  }
