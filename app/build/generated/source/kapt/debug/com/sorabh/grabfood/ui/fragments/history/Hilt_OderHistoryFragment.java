 ...
 */
public abstract class Hilt_OderHistoryFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OderHistoryFragment_GeneratedInjector) this.generatedComponent()).injectOderHistoryFragment(UnsafeCasts.<OderHistoryFragment>unsafeCast(this));
    }
  }
