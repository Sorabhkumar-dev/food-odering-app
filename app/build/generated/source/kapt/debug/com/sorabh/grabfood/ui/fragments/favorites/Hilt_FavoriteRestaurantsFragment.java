...
public abstract class Hilt_FavoriteRestaurantsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteRestaurantsFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteRestaurantsFragment(UnsafeCasts.<FavoriteRestaurantsFragment>unsafeCast(this));
    }
  }
