...
import com.sorabh.grabfood.domain.di.AppModule_ProvideRetrofitClientFactory;
...
public final class DaggerGrabFoodApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends GrabFoodApplication_HiltComponents.FragmentC {
    ...
    private RestaurantHomeAdapter restaurantHomeAdapter() {
    ...
    private CartFragment injectCartFragment2(CartFragment instance) {
      CartFragment_MembersInjector.injectRepository(instance, singletonCImpl.networkRepository());
      CartFragment_MembersInjector.injectCartAdapter(instance, new CartAdapter());
      CartFragment_MembersInjector.injectLocalDBRepository(instance, localDBRepository());
      return instance;
    }

    private FavoriteRestaurantsFragment injectFavoriteRestaurantsFragment2(
        FavoriteRestaurantsFragment instance) {
      FavoriteRestaurantsFragment_MembersInjector.injectRestaurantHomeAdapter(instance, restaurantHomeAdapter());
      FavoriteRestaurantsFragment_MembersInjector.injectLocalDBRepository(instance, localDBRepository());
      return instance;
    }
    ...
    private HomeFragment injectHomeFragment2(HomeFragment instance) {
      HomeFragment_MembersInjector.injectRepository(instance, singletonCImpl.networkRepository());
      HomeFragment_MembersInjector.injectRestaurantHomeAdapter(instance, restaurantHomeAdapter());
      HomeFragment_MembersInjector.injectLocalDBRepository(instance, localDBRepository());
      return instance;
    }
    ...
    private RestaurantMenuFragment injectRestaurantMenuFragment2(RestaurantMenuFragment instance) {
      RestaurantMenuFragment_MembersInjector.injectRepository(instance, singletonCImpl.networkRepository());
      RestaurantMenuFragment_MembersInjector.injectRestaurantMenuAdapter(instance, restaurantMenuAdapter());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends GrabFoodApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(8).add(CartViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(ForgotPasswordViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(LoginViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(OderHistoryVieModel_HiltModules_KeyModule_ProvideFactory.provide()).add(OtpViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(RestaurantMenuViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(SignUpViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends GrabFoodApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.oderHistoryVieModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 4);
      this.otpViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 5);
      this.restaurantMenuViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 6);
      this.signUpViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 7);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(8).put("com.sorabh.grabfood.ui.viewmodel.CartViewModel", ((Provider) cartViewModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.ForgotPasswordViewModel", ((Provider) forgotPasswordViewModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.LoginViewModel", ((Provider) loginViewModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.OderHistoryVieModel", ((Provider) oderHistoryVieModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.OtpViewModel", ((Provider) otpViewModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.RestaurantMenuViewModel", ((Provider) restaurantMenuViewModelProvider)).put("com.sorabh.grabfood.ui.viewmodel.SignUpViewModel", ((Provider) signUpViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new CartViewModel(viewModelCImpl.getOderConfirmationUseCase());

          case 1: // com.sorabh.grabfood.ui.viewmodel.ForgotPasswordViewModel 
          return (T) new ForgotPasswordViewModel(viewModelCImpl.getForgotPasswordUseCase());

          case 2: // com.sorabh.grabfood.ui.viewmodel.HomeViewModel 
          return (T) new HomeViewModel(viewModelCImpl.getRestaurantUseCase());

          case 3: // com.sorabh.grabfood.ui.viewmodel.LoginViewModel 
          return (T) new LoginViewModel(viewModelCImpl.getLoginResponseUseCase());

          case 4: // com.sorabh.grabfood.ui.viewmodel.OderHistoryVieModel 
          return (T) new OderHistoryVieModel(viewModelCImpl.getOderHistoryUseCase());

          case 5: // com.sorabh.grabfood.ui.viewmodel.OtpViewModel 
          return (T) new OtpViewModel(viewModelCImpl.getOTPUseCase());

          case 6: // com.sorabh.grabfood.ui.viewmodel.RestaurantMenuViewModel 
          return (T) new RestaurantMenuViewModel(viewModelCImpl.getRestaurantMenuUseCase());

          case 7: // com.sorabh.grabfood.ui.viewmodel.SignUpViewModel 
  ...
  private static final class SingletonCImpl extends GrabFoodApplication_HiltComponents.SingletonC {
    ...
    private NetworkInterface networkInterface() {
      return AppModule_ProvideNetworkInterfaceFactory.provideNetworkInterface(appModule, AppModule_ProvideRetrofitClientFactory.provideRetrofitClient(appModule));
    }
