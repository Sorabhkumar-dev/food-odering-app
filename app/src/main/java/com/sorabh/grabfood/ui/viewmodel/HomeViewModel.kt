...
@HiltViewModel
class HomeViewModel @Inject constructor(private val getRestaurantUseCase: GetRestaurantUseCase):ViewModel() {
    private val _restaurantFlow:MutableStateFlow<Result<Restaurant>> = MutableStateFlow(Result.Loading())
